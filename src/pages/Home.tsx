...
import { ArrowRight, Beaker, ShieldCheck, Microscope, Database, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="space-y-20 pb-16" id="home-page-container">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-teal-deep text-white p-8 sm:p-12 rounded-3xl relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-8 shadow-lg">
          <div className="space-y-4 max-w-2xl">
            <h3 className="text-2xl sm:text-3xl font-serif font-bold text-gold-pale">Multidisciplinary Collaboration</h3>
            <p className="text-xs sm:text-sm text-white/85 leading-relaxed">
              We coordinate regularly with internal university departments, veterinary wings, agricultural institutes, and public health practitioners. Under the <strong>One Health Initiative</strong>, we share findings that connect animal farming hygiene directly to multi-resistant clinical pathogens.
            </p>
          </div>
          <div className="flex-shrink-0 flex items-center gap-4 border border-white/10 bg-white/5 p-4 rounded-2xl">
            <Microscope className="w-8 h-8 text-gold" />
            <div className="text-left font-mono">
              <p className="text-[10px] text-gold-pale font-bold uppercase tracking-wider">GEB DEPARTMENT</p>
              <p className="text-[11px] text-white">University of Rajshahi</p>
            </div>
          </div>
        </div>
      </section>
