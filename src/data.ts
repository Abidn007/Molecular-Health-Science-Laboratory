...
export const RESEARCH_THEMES: ResearchTheme[] = [
  {
    ...
    iconName: 'Activity',
    status: 'ongoing',
    imageUrl: '../assets/images/theme_clinical_1783104675878.jpg'
  },
  {
    id: 'theme-2',
    number: 'Theme #2',
    ...
    iconName: 'Leaf',
    status: 'ongoing',
    imageUrl: '../assets/images/theme_agricultural_1783104687353.jpg'
  },
  {
    id: 'theme-5',
    number: 'Theme #3',
    ...
    status: 'ongoing',
    imageUrl: '../assets/images/theme_resistance_1783104703215.jpg'
  },
  {
    id: 'theme-6',
    number: 'Theme #4',
    ...
    iconName: 'Sparkles',
    status: 'ongoing',
    imageUrl: '../assets/images/theme_therapeutics_1783104721709.jpg'
  },
  {
    id: 'theme-7',
    number: 'Theme #5',
    ...
    iconName: 'Dna',
    status: 'ongoing',
    imageUrl: '../assets/images/theme_molecular_1783104738281.jpg'
  }
];
...
export const LABORATORY_SERVICES: LaboratoryService[] = [
  { id: 'srv-1', name: 'Bacterial Isolation', priceBDT: 2500, category: 'Microbiology', duration: '3-5 Days' },
  ...
  { id: 'srv-5', name: 'Gram Staining', priceBDT: 300, category: 'Microscopy', duration: 'Same Day' },
  { id: 'srv-6', name: 'Bacterial Enumeration (CFU Count)', priceBDT: 1200, category: 'Microbiology', duration: '2 Days' },
  { id: 'srv-7', name: 'Sample Processing', priceBDT: 1000, category: 'Prep Work', duration: '1 Day' },
  { id: 'srv-8', name: 'Culture Purification', priceBDT: 1500, category: 'Microbiology', duration: '3 Days' }
];
